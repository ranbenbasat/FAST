...
To run, you will need a trace in which each line is a flow identifier, space, and size of packet. For example:
0 167
0 1460
4 40
...
Inside hh.cc you'll need to determine which algorithms you wish to run (we recommand running one at a time when measuring speed).
