...
typedef struct CS_type {
	...
	unsigned int *signhasha, *signhashb;
} CS_type;
...
extern CS_type * CS_Init(int, int, int);
extern void CS_Destroy(CS_type *);
extern void CS_Update(CS_type *, unsigned int, int);
extern void CS_Query(CS_type *, int);
extern int CS_Size(CS_type * cm);
